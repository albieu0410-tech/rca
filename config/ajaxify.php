...
if(getUserConfig("use_locale_jquery")!="fara") require_once("config/layers.php");
...
if(getUserConfig("use_locale_jquery")!="fara") require_once("config/sheet.php");
if(getUserConfig("use_locale_jquery")!="fara") jQueryPluginRequired("jquery.form");
ob_start();?><script>
